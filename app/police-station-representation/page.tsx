...
export const metadata: Metadata = {
  ...
  description:
    'Criminal defence barrister at the police station, 24/7. Call before the interview begins — Astons Law Chambers attends in person. Legal Aid available. Call 07922 247 999.',
