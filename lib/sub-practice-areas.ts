...
export const subPracticeAreas: SubPracticeArea[] = [
    ...
    faqs: [
      {
        ...
        a: 'Yes. The offence depends on the reading and on the procedure used to obtain it, and both can be examined. A reading over the limit does not always mean the case is unanswerable.',
      },
      {
        q: 'Can I avoid a disqualification?',
        a: 'On conviction a disqualification is the normal outcome and usually cannot be avoided. The exception is a special reasons argument, which asks the court not to disqualify where the circumstances of the offence are genuinely exceptional. Whether it is realistic depends on the facts.',
      },
      {
        q: 'What if I refused to give a sample?',
        a: 'Failing to provide a specimen without a reasonable excuse is a separate offence, treated as seriously as driving over the limit and sometimes more so. Whether there was a reasonable excuse is itself something that can be argued.',
      },
      {
        q: 'What happens at the police station?',
        a: 'After a positive roadside test you are taken to the station for a formal specimen on approved equipment. How that procedure is carried out is often central to the case, which is why advice at that stage matters.',
      },
    ],
    context: {
      eyebrow: 'Disqualification',
      title: 'For most people, the licence is what the case is about.',
      body: 'Whether there is anything to argue usually comes down to the reading and how the procedure was followed at the station.',
    },
    policeStation: {
    ...
    faqs: [
      {
        ...
        a: 'It can be. The offence can catch drivers on prescription medicine, but there is a defence where the drug was prescribed and taken in line with the advice given, provided your driving was not impaired. Whether it applies depends on the medication and the dose.',
      },
      {
        q: 'Can a blood test result be challenged?',
        a: 'Yes. How the sample was taken, stored, and analysed all affect how much weight the result carries, and delay or poor handling can undermine it.',
      },
      {
        q: 'Do the police have to prove I was impaired?',
        a: 'For the limit-based offence, no. The prosecution only has to show the drug was in your blood above the set limit, not that your driving was affected. Impairment matters for a separate, older offence.',
      },
      {
        q: 'How long do drugs stay in the system?',
        a: 'Traces of some drugs, cannabis in particular, can remain in the blood for days after any effect has worn off, which is part of why these cases are contested.',
      },
    ],
    context: {
      eyebrow: 'Prescribed medication',
      title: 'A prescription is not an automatic defence.',
      body: 'Whether the medical defence applies depends on the prescription, the dose, and the advice you were given.',
    },
    policeStation: {
    ...
    faqs: [
      {
        ...
        a: 'Sometimes. Once you reach the threshold a disqualification is the default, but the court can decide not to impose it if you prove exceptional hardship. Whether that argument is realistic depends on your circumstances.',
      },
      {
        q: 'What counts as exceptional hardship?',
        a: 'Ordinary hardship — the inconvenience of not driving, or even losing your own job — is usually not enough on its own. The court looks for hardship that goes further, often the serious effect a ban would have on other people who depend on you.',
      },
      {
        q: 'Can I use the same hardship reasons again later?',
        a: 'Generally not. If an argument succeeds, you usually cannot rely on the same grounds again within the following few years, so the reasons put forward need to be chosen carefully.',
      },
      {
        q: 'What happens to new drivers?',
        a: 'New drivers are treated more strictly. Passing a lower points threshold in the first couple of years after passing revokes the licence altogether, which means returning to a provisional licence and retaking the test.',
      },
    ],
    context: {
      eyebrow: '12 points',
      title: 'The argument turns on the effect on others.',
      body: 'Courts consider dependants, employment, and those who rely on the driver. Personal inconvenience alone is not enough.',
    },
    ...
    faqs: [
      {
        ...
        a: 'Yes. You can be charged even where you say you acted in self-defence; the question is then whether the prosecution can disprove it. Self-defence succeeds where the force was honestly thought necessary and was reasonable in the circumstances as you saw them.',
      },
      {
        q: 'What is the difference between the two forms of GBH?',
        a: 'Both involve really serious harm, but they differ on intent. The more serious form requires proof that you meant to cause that harm; the lesser form only requires that you were reckless as to causing some harm. The form charged sets the court and the sentencing range.',
      },
      {
        q: 'Will I go to prison for GBH?',
        a: 'GBH is a serious offence and a custodial sentence is a real prospect, especially for the intent form. Sentence turns on the level of harm, the circumstances, and mitigation, and reducing a charge from the intent form to the lesser form can make a significant difference.',
      },
      {
        q: 'Can I get bail?',
        a: 'Bail is decided at the first hearing and is often contested in GBH cases, where the court weighs the seriousness and any risk to witnesses. There is still an argument to be made, and how it is put matters.',
      },
    ],
    context: {
    ...
    faqs: [
      {
        ...
        a: 'It can be. Needing a blade for work is a recognised good reason, but it has to fit the facts: what the item was, why you had it at that moment, and where you were stopped. The same does not apply to carrying something for protection.',
      },
      {
        q: 'I did not know the knife was there — can I still be convicted?',
        a: 'Knowledge matters. If you genuinely did not know the item was on you or in your vehicle, that goes to the heart of the case, though it has to be supported by the circumstances.',
      },
      {
        q: 'Will I go to prison for carrying a knife?',
        a: 'Custody is a real possibility. The courts treat knife possession as a deterrent matter, and a second possession offence in particular carries a minimum custodial sentence in most cases. The circumstances and mitigation still matter.',
      },
      {
        q: 'I am under 18 — does it work differently?',
        a: 'Yes. A young person’s case is heard in the Youth Court under its own procedure, with reporting restrictions and a parent or guardian involved, and the approach to sentence is different from the adult courts.',
      },
    ],
    context: {
      eyebrow: 'Custody risk',
      title: 'Defences turn on what was found, where, and why.',
      body: 'Lawful excuse and good reason must be argued with evidence.',
    },
    policeStation: {
    ...
    faqs: [
      {
        ...
        a: 'It can. The decision to prosecute belongs to the Crown, not the complainant, and cases sometimes continue on other evidence such as messages or a recorded 999 call. How strong that evidence is can be tested.',
      },
      {
        q: 'I have been given bail conditions — can I challenge them?',
        a: 'Yes. Conditions such as being kept out of your home or away from your children can be challenged, and the court can vary them. Whether a challenge is likely to succeed depends on the circumstances.',
      },
      {
      ...
      },
      {
        ...
        a: 'If the matter is dropped with no charge or caution, there is no conviction. An arrest can still be recorded, and a caution counts differently from a charge, so what shows up later depends on how the case ends.',
      },
    ],
    context: {
    ...
    faqs: [
      {
        ...
        a: 'Possibly. Bail is contested in robbery cases, and the court weighs the seriousness and any risk to witnesses, so remand is a real prospect. There is still a bail argument to make, and how it is presented matters.',
      },
      {
        q: 'The CCTV does not clearly show me — does that matter?',
        a: 'Yes. Identification is often the weakest part of a robbery case. Unclear footage, a brief sighting, or a masked suspect all give grounds to test how safe the identification really is.',
      },
      {
        q: 'I was there but I did not use force — will I still be convicted?',
        a: 'Not automatically. The prosecution would have to show you shared the plan to use force and steal, not merely that you were present. What you knew and what you did are exactly what the defence examines.',
      },
      {
        q: 'What makes it robbery rather than theft?',
        a: 'Robbery is theft combined with force, or the threat of force, used in order to steal. If force was not used to carry out the theft — for example a fight that happened to be followed by a taking — the right charges may be separate theft and assault, which are treated differently.',
      },
    ],
    context: {
      eyebrow: 'Crown Court',
    ...
    faqs: [
      {
        ...
        a: 'Rarely by catching someone in the act. Intent is usually inferred from the surrounding evidence — the quantity, individual packaging, scales, cash, and messages on a phone. Because it is built on inference, each part of it can be questioned.',
      },
      {
        q: 'What if I was holding them for someone else?',
        a: 'Holding drugs for another person can still be supply in law, but the circumstances matter a great deal, including whether you were pressured or exploited into doing it. How that is presented can change the charge or the sentence.',
      },
      {
        q: 'What if they were for my own use?',
        a: 'Personal use, even of a larger amount bought in bulk, is a recognised answer to an intent to supply allegation. Whether it succeeds depends on the quantity and the rest of the evidence, but it can reduce the charge to simple possession.',
      },
      {
        q: 'Will legal aid cover this?',
        a: 'Astons Law Chambers is not a legal aid contract holder. Where legal aid applies, it is arranged through a partner solicitor firm at no cost to you.',
      },
    ],
    context: {
...

  {
    ...
    faqs: [
      {
        ...
        a: 'Heavily. Sentencing for supply is built around the part you played — from leading an operation down to acting as a runner under direction. Establishing the right role, rather than accepting the prosecution’s, is often the most valuable part of the defence.',
      },
      {
        q: 'I was just delivering — will that help?',
        a: 'It can. Acting as a courier under direction is treated very differently from organising the supply. The prosecution’s characterisation of your role is not the final word, and it can be contested with the evidence.',
      },
      {
        q: 'Can I be convicted on text messages alone?',
        a: 'Potentially. Messages offering or arranging drugs, linked to a phone said to be yours, can support a conviction even without drugs being found on you. That makes attribution — proving the phone was actually yours — a key area of challenge.',
      },
      {
    ...
    context: {
      ...
      body: 'What the defendant did, what they knew, and what they gained from it all form part of the case.',
    },
    policeStation: {
    ...
    faqs: [
      {
        ...
        a: 'It is a defence for people who committed an offence because they were forced to through exploitation or trafficking. If it is established, it can prevent a conviction altogether. Whether it applies depends on the individual’s circumstances.',
      },
      {
        q: 'How do I know if the exploitation defence applies?',
        a: 'It depends on how the person came to be involved: whether they were coerced, threatened, or controlled, and how old they are, since the protection is stronger for under-18s. A formal assessment can help establish it, and that process can be started early.',
      },
      {
        q: 'What is cuckooing?',
        a: 'It is where a gang takes over the home of a vulnerable person and uses it as a base for dealing. Recognising that someone was a victim of cuckooing, rather than a willing participant, can change the whole direction of their case.',
      },
      {
        q: 'My child has been arrested — what should I do?',
        a: 'Call as early as possible, and raise any sign that they were pressured or exploited before the interview takes place. Children drawn into county lines are often victims first, and that has to be identified from the outset. A parent or guardian can be present.',
      },
    ],
    context: {
      eyebrow: 'Modern Slavery Act',
      title: 'Exploitation can be a complete defence.',
      body: 'Where someone was forced into carrying drugs, recognising the exploitation early can change the case.',
    },
    policeStation: {
