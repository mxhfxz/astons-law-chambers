...
export const practiceAreas: PracticeArea[] = [
  {
    ...
    faqs: [
      ...
      { q: 'What if I am at a police station now?', a: 'Police station support can be arranged straight away. You can ask the custody officer to hold the interview until a representative is present.' },
    ...
    context: {
      ...
      body: 'Police station support is available at any hour.',
    },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Will I get bail?', a: 'Bail turns on the allegation, prior history, and the conditions that can realistically be offered.' },
  ...
  },
  {
    ...
    faqs: [
      { q: 'My child has been arrested — what do I do first?', a: 'Police station support can be arranged straight away. The young person is entitled to a parent or guardian present at the interview.' },
      { q: 'Will the case stay in the Youth Court?', a: 'Most youth matters remain in the Youth Court. Some are sent to the Crown Court depending on the allegation and the client’s age.' },
  ...
  },
  {
    ...
    faqs: [
      { q: 'Can I avoid a ban under totting-up?', a: 'An exceptional-hardship argument is available in some cases. It is not automatic.' },
    ...
    context: {
      ...
      title: 'A written fee before any work begins.',
      body: 'After a short conversation you receive a client-care letter setting out the scope and the fee.',
    },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'I’ve been told to expect a long sentence — is that right?', a: 'It is too early to know. Sentence depends on the role accepted, the weight, and personal mitigation.' },
    ],
    context: {
      eyebrow: 'Disclosure',
      title: 'Drug cases turn on the disclosure.',
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Can I appeal just the sentence?', a: 'Yes. Sentence-only appeals are common. Grounds depend on the principles applied and the facts.' },
      { q: 'My trial lawyer said an appeal isn’t worth it — is that final?', a: 'No. A second opinion on prospects is part of the work.' },
    ],
    context: {
  ...
  },
  {
    ...
    faqs: [
      { q: 'Can a family instruct directly?', a: 'Yes. Inquest instructions are accepted under the Direct Access scheme where suitable.' },
    ...
    context: {
      ...
      body: 'The pre-inquest review is where the questions the inquest will examine are decided.',
    },
    ...
    faqs: [
      {
        ...
        a: 'Yes. The investigation stage is when the prosecution builds its case, and the most important decisions are often made before any interview. Getting advice before you respond protects your position.',
      },
      {
      ...
      },
      {
        ...
        a: 'Yes. How devices and accounts were seized and examined, and what the data actually shows in context, are all open to challenge. Messages and records can read very differently once the full picture is disclosed.',
      },
      {
    ...
    faqs: [
      {
        ...
        a: 'The investigation can take many months, and bail conditions may restrict where you go and who you contact while it continues. You can be represented throughout, not only once charged, and acting early protects your account.',
      },
      {
        q: 'Can the investigation be kept confidential?',
        a: 'The first call is in complete confidence. A person under investigation is not usually named publicly, though that can change once a charge is brought. What can be kept private at each stage is explained on the call.',
      },
      {
        q: 'What is a Sexual Harm Prevention Order?',
        a: 'It is a court order that can be imposed after conviction and may restrict things such as internet use, travel, or contact with named people. Its terms can be argued, and how it would apply is addressed as part of the case.',
      },
      {
